  ...
  return (
    <div className="flex w-full max-w-7xl flex-col md:flex-row">
      <div className="w-full p-4 md:w-1/2">
        <div className={`mt-6 basis-1/4 p-6 text-center sm:mt-0 ${styles.dl}`}>
          <h3 className="mb-4 text-3xl font-bold">
            Languages &amp; <br className="sm:hidden" />
            Stacks
          </h3>
      ...
      <div className="w-full p-4 md:w-1/2">
        <div className={`mt-4 mt-0 basis-1/4 p-6 text-center ${styles.dl}`}>
          <h3 className=" mb-4 text-3xl font-bold">
