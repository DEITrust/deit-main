...
const metadata = {
  ...
  description:
    'Consulting, development and Fractional CTO services for web3 projects, small teams, and small/medium sized businesses.',
  keywords:
    'consulting, development, fractional cto, web3, backend, fullstack, technologist, nextjs, reactjs, solidity, go, python, gnoland, erc2535, aws, terraform, Canadian',
}
